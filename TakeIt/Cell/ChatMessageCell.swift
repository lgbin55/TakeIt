...
class ChatMessageCell: UICollectionViewCell {
    ...
    func setAnchors() {
        ...
        containerViewLeftAnchor = containerView.leftAnchor.constraint(equalTo: leftAnchor, constant: 8)
        containerViewRightAnchor = containerView.rightAnchor.constraint(equalTo: rightAnchor, constant: -8)
        ...
        textLabel.leftAnchor.constraint(equalTo: containerView.leftAnchor, constant: 6).isActive = true
        textLabel.rightAnchor.constraint(equalTo: containerView.rightAnchor, constant: -6).isActive = true
